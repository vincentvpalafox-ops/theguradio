...
4. `powershell -ExecutionPolicy Bypass -File PASS_HANDOFF_0034_2026-04-24/proof_bundle/Invoke-PreviewProofBundleIntegrity.ps1 -OutDir tmp_pass0042_integrity`
   - Result: `overall_pass = true`

5. `git diff --check -- PASS_HANDOFF_0042_2026-04-24`
   - Result: pass
